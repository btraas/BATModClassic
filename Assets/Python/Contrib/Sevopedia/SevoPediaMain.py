...
#
# additional work by Gaurav, Progor, Ket, Vovan, Fitchn, LunarMongoose, EmperorFool, Lemon Merchant (for BAT 3)
...
#  BAT 3.0  LM  06/28/10
#
#  Calls new function to sort extra female units in Sevopedia for SaibotLieh's female units
#  instead of standard sort routine
#  Begin
#================================================================
		# New function call
		return self.getSortedUnitList(gc.getNumUnitInfos(), gc.getUnitInfo)
			
		# Old Code
		#return self.getSortedList(gc.getNumUnitInfos(), gc.getUnitInfo)
		
#==========================================
#  New BAT 3.0 code ends
#==========================================	
...
#================================================================
		# New function call
		return self.getSortedUnitList(gc.getNumSpecialistInfos(), gc.getSpecialistInfo)
		# Old Code
...
#  BAT 3.0  LM  06/28/10
#
#  New function to sort extra female units in Sevopedia for SaibotLieh's female units
#  used instead of standard 'getSortedList' function
#  Keeps Great People, CEOs, and Missionaries from appearing twice in unit lists
#  Begin
#================================================================
	def getSortedUnitList(self, numInfos, getInfo, noSort=False):
		list = []
		for i in range(numInfos):
			item = getInfo(i)

...
# Added by LM for Xienwolf's Era HUDs
g_EraHUD = true
...
# BUG - field of view slider - end
"""
# BAT - Era based HUD - begin
	def setEraHud(self, iEra):
	
		# This function is a rewrite of Xienwolf's Era/Religion HUD changer to conform to BUG and BTS 3.19
		
		if g_EraHUD == False:
			return
		
		sPanelPath = "Art/Interface/Screens/"
		sEraPath = ""
		
		# New HUD panel widget defines
		screen.addPanel( "InterfaceTopLeftBackgroundWidget", u"", u"", True, False, 258, 0, xResolution - 516, yResolution-149, PanelStyles.PANEL_STYLE_STANDARD )
		screen.addPanel( "InterfaceCenterLeftBackgroundWidget", u"", u"", True, False, 0, 0, 258, yResolution-149, PanelStyles.PANEL_STYLE_STANDARD )
		screen.addPanel( "InterfaceCenterRightBackgroundWidget", u"", u"", True, False, xResolution - 258, 0, 258, yResolution-149, PanelStyles.PANEL_STYLE_STANDARD )
		screen.addPanel( "CityScreenTopWidget", u"", u"", True, False, 0, -2, xResolution, 41, PanelStyles.PANEL_STYLE_STANDARD )
		...
		# Set art path according to iEra
		if iEra == 0:
			sEraPath = "Ancient/"
		elif iEra == 1:
			sEraPath = "Classical/"
			...
			# This is the default standard panel and will be drawn if iEra returns something weird
			screen.setStyle( "InterfaceTopLeftBackgroundWidget", "Panel_City_Top_Style" )
			screen.setStyle( "InterfaceCenterLeftBackgroundWidget", "Panel_City_Left_Style" )
			screen.setStyle( "InterfaceCenterRightBackgroundWidget", "Panel_City_Right_Style" )
			screen.setStyle( "CityScreenTopWidget", "Panel_TopBar_Style" )
		...
		# Screen is called based on art path from iEra if statements
		screen.addDDSGFC( "InterfaceTopLeftBackgroundWidget", sPanelPath+sEraPath+'CityHud_C.tga', 258, 0, xResolution - 516, 189, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		screen.addDDSGFC( "InterfaceCenterLeftBackgroundWidget", sPanelPath+sEraPath+'CityHud_L.tga', 0, 0, 308, yResolution-149, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		screen.addDDSGFC( "InterfaceCenterRightBackgroundWidget", sPanelPath+sEraPath+'CityHud_R.tga', xResolution - 298, 0, 298, yResolution-149, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		screen.addDDSGFC( "CityScreenTopWidget", sPanelPath+sEraPath+'CityHud_T.tga', 0, -2, xResolution, 41, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		screen.addDDSGFC( "CityNameBackground", sPanelPath+sEraPath+'CityTitle.tga', 260, 31, xResolution - (260*2), 38, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		screen.addDDSGFC( "InterfaceCenterBackgroundWidget", sPanelPath+sEraPath+'MainHud_BC.tga', 276, yResolution - 133, xResolution - (276*2), 133, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		screen.addDDSGFC( "InterfaceLeftBackgroundWidget", sPanelPath+sEraPath+'MainHud_BL.tga', 0, yResolution - 178, 304, 178, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		screen.addDDSGFC( "InterfaceRightBackgroundWidget", sPanelPath+sEraPath+'MainHud_BR.tga', xResolution - 324, yResolution - 178, 324, 178, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		screen.addDDSGFC( "InterfaceTopCenter", sPanelPath+sEraPath+'MainHud_TC.tga', 237, -2, xResolution-(237*2), 60, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		screen.addDDSGFC( "InterfaceTopLeft", sPanelPath+sEraPath+'MainHud_TL.tga', 0, -2, 287, 60, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		screen.addDDSGFC( "InterfaceTopRight", sPanelPath+sEraPath+'MainHud_TR.tga', xResolution - 287, -2, 287, 60, WidgetTypes.WIDGET_GENERAL, -1, -1 )
